...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://task-manager-bishal.herokuapp.com/graphql/graphql", {
      method: "POST",
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'loginOutput', id: string, username: string, email: string, token: string } };
...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'Task', id: string, title: string, status: string } };
...
export type GetMyTasksQuery = { __typename?: 'Query', getAllMyTasks: Array<{ __typename?: 'Task', id: string, title: string, status: string }> };
...
export const useGetMyTasksQuery = <
    ...
    useQuery<GetMyTasksQuery, TError, TData>(
      ...
      fetcher<GetMyTasksQuery, GetMyTasksQueryVariables>(GetMyTasksDocument, variables),
      options
    );